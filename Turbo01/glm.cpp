...
glmReadOBJ(char* filename)
{
    ...
    model->m_Position[1] = 0.0;
    model->m_Position[2] = 0.0;
...
/* glmReadPPM: read a PPM raw (m_CarType P6) file.  The PPM file has a header
 ...
 *    rgbrgbrgb...
 *
 * where "P6" is the magic cookie which identifies the file m_CarType and
